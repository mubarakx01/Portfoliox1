...
export default function Footer() {
  return (
    <footer className="py-16 md:py-32" data-oid="r_e8-:e">
      <div className="mx-auto max-w-5xl px-6" data-oid="k_uf8kz">
        <Link
          href="/"
          aria-label="go home"
        ...
        >
          {links.map((link, index) => (
            <Link
              ...
              data-oid="cr6vb5r"
            >
              <span data-oid="o_u976:">{link.title}</span>
            </Link>
          ))}
        </div>
        <div
