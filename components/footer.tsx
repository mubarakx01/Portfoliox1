...
export default function EnhancedFooter() {
  return (
    <footer className="py-16 md:py-32 bg-background" data-oid="-p:vaw6">
      <div className="mx-auto max-w-5xl px-6" data-oid="ptcpios">
        <Link
          href="/"
          aria-label="go home"
        ...
        >
          {links.map((link, index) => (
            <Link
              ...
              data-oid="_kt-nt6"
            >
              <span data-oid="a1m_c8:">{link.title}</span>
            </Link>
          ))}
        </div>
        <div
