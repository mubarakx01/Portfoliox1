...
export default function Footer() {
  return (
    <footer className="py-16 md:py-32" data-oid="uu2cupd">
      <div className="mx-auto max-w-5xl px-6" data-oid="y1c.oor">
        <Link
          href="/"
          aria-label="go home"
        ...
        >
          {links.map((link, index) => (
            <Link
              ...
              data-oid="5q3qprv"
            >
              <span data-oid="kitg_ez">{link.title}</span>
            </Link>
          ))}
        </div>
        <div
