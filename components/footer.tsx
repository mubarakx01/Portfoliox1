...
export default function Footer() {
  return (
    <footer className="py-16 md:py-32" data-oid="7dbrm5y">
      <div className="mx-auto max-w-5xl px-6" data-oid="sft4bxw">
        <Link
          href="/"
          aria-label="go home"
        ...
        >
          {links.map((link, index) => (
            <Link
              ...
              data-oid="s:eco6j"
            >
              <span data-oid="oj28s15">{link.title}</span>
            </Link>
          ))}
        </div>
        <div
