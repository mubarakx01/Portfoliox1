    ...
    >
      ...
      >
        ...
        >
          ...
          <ScrollReveal delay={0.1} data-oid="s6fvek6">
            <h1
          ...
          <ScrollReveal delay={0.2} data-oid="e9ev1pw">
            <p
            ...
            >
              {isClient && displayedText.length === fullText.length ? (
                ...
                <>
                  {displayedText}
                  {isClient && (
                    <span className="animate-pulse" data-oid="y0zcu1q">
                      |
                    </span>
                  )}
                </>
          ...
          <ScrollReveal delay={0.3} data-oid="2-i01_k">
            <div
          ...
          <ScrollReveal delay={0.4} data-oid=":258xvb">
            <div
            ...
            >
              <Button
                ...
                data-oid="vm8h94l"
              >
                <span className="relative z-10" data-oid="o8izcb4">
                  View Projects
                </span>
                <span
              ...
              <Button
                ...
                data-oid="nxmejfo"
              >
                <span className="relative z-10" data-oid=".4mz9_z">
                  Contact Me
                </span>
                <span
              ...
              <Button
                ...
                data-oid="hqxczp."
              >
                <a href="/AI_x1.pdf" download="AI_x1.pdf" data-oid="taztz2:">
                  <span
          ...
          <ScrollReveal delay={0.5} data-oid="nisd92w">
            <div
            ...
            >
              ...
              >
                <a
                  ...
                  data-oid="kpiqg6_"
                >
                  <Github className="h-5 w-5" data-oid="nrhqf5v" />
                </a>
              </Button>
              <Button
                variant="ghost"
              ...
              >
                <a
                  ...
                  data-oid="--q0mxi"
                >
                  <Linkedin className="h-5 w-5" data-oid="kumrx76" />
                </a>
              </Button>
              <Button
                variant="ghost"
              ...
              >
                <a
                  ...
                  data-oid="e.q6tjw"
                >
                  <Mail className="h-5 w-5" data-oid=".4esqxl" />
                </a>
              </Button>
            </div>
          </ScrollReveal>
        ...
        <div
          ...
          data-oid="_-v:-_0"
        >
          <ScrollReveal direction="left" data-oid="rf_h9xs">
            <motion.div
          ...
          >
            ...
            >
              <Button
                ...
                data-oid="tf42tcj"
              >
                <ArrowDown className="h-4 w-4" data-oid="f1m7qxm" />
              </Button>
            </motion.div>
          </div>
        )}
