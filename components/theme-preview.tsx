...
export function ThemePreview({ className }: ThemePreviewProps) {
  ...
  if (!mounted) {
    return (
      <Card
        ...
        data-oid="zfgu1-t"
      >
        <CardContent className="p-4" data-oid="stk9uek">
          <div
            className="h-[150px] flex items-center justify-center"
            data-oid="fuo3-on"
          >
            <div className="animate-pulse" data-oid="u8jmymu">
  ...
  return (
    <Card
      ...
      data-oid="r7rwj3z"
    >
      <CardContent className="p-4" data-oid="ei5dc-8">
        <div className="flex items-center gap-2 mb-3" data-oid=".h:ozyx">
          <Palette className="h-4 w-4 text-primary" data-oid="u5fh.wd" />
          <h3 className="text-sm font-medium" data-oid="b4bpeh4">
            Theme Customization
          </h3>
        </div>

        <div className="flex flex-wrap gap-2 mb-3" data-oid="j_odoqe">
          <Button
        ...
        <div className="grid grid-cols-3 gap-2" data-oid="9g-tw.7">
          {colorOptions.map((option) => (
            ...
            >
              ...
              <span className="text-xs mt-1" data-oid="09lqweg">
                {option.label}
              </span>
              {colorTheme === option.value && (
                <motion.div
                  ...
                  data-oid="tfo.ria"
                >
                  <Check className="h-3 w-3" data-oid="i_lnw02" />
                </motion.div>
              )}
            </motion.button>
          ))}
